...
图8.2：上图为x∈r2 kxk2≤1，下图为x∈r3 kxk2≤1。
...
被称为H–older不等式。对于p=2，这是柯西-施瓦兹不等式。
...
这个单位是不起作用的。足以证明任何Normx 7→Kis紧凑型。现在我们回顾一下，因为函数xk对于norm k k是连续的，所以等价于1-范数。我们已经证明了k1，并且我们观察到f:x 7→kxk
